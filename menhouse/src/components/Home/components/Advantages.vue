...
<template>
    ...
    <form action="https://apple.com" target="_blank"><button class="container-background-button advantage">Записаться</button></form>
</template>
...
.our.advantages {
  ...
  margin-top: 10px; /* или любой другой отступ, который вам нужен */
}
